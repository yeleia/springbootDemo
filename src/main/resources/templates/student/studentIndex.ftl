...
<head>
    ...
    <style>
        /** skins **/
        #zheng-upms-server #header {background: #121ba1;}
        #zheng-upms-server .content_tab{background: #121ba1;}
        #zheng-upms-server .s-profile>a{background: darkblue; left top no-repeat;}
        ...
        #zheng-oss-web #header {background: #121ba1;}
        #zheng-oss-web .content_tab{background: #121ba1;}
            ...
            <ul class="hi-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dm-icon pull-right">
                        ...
                        <li>
                            <a class="waves-effect" href="${request.contextPath}/student/outlogin;"><i class="zmdi zmdi-run"></i> 退出登录</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<section id="main">
    ...
    <aside id="sidebar">
        ...
        <div class="s-profile">
            ...
            <ul class="main-menu">
                <li>
                    <a class="waves-effect" href="javascript:Tab.addTab('个人资料', '${request.contextPath}/student/seeMyMessage');"><i class="zmdi zmdi-account"></i> 个人资料</a>
                </li>
        ...
        <ul class="main-menu">
            ...
            <li class="sub-menu system_menus system_1 0">
                ...
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('选择课题', '${request.contextPath}/student/toChoseProject');">选择课题</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('我的论文', '${request.contextPath}/student/myPaper');">我的论文</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('上传记录', '${request.contextPath}/student/myhistory');">上传记录</a></li>
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 3">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-accounts"></i>导师信息</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('查看导师', '${request.contextPath}/student/seeMyMenitor');">查看导师</a></li>
<#--                    <li><a class="waves-effect" href="javascript:Tab.addTab('添加学生', '/manage/user/index');">添加学生</a></li>-->
                </ul>
            </li>
            <li class="sub-menu system_menus system_1 6">
                <a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-lock-outline"></i> 资源管理</a>
                <ul>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('查看资料', '${request.contextPath}/student/seeMaterial');">查看资料</a></li>
<#--                    <li><a class="waves-effect" href="javascript:Tab.addTab('添加资料', '/manage/permission/index');">添加资料</a></li>-->
                </ul>
            </li>
           <#-- <li class="sub-menu system_menus system_1 7">
                ...
                <ul>
                    ...
                    <li><a class="waves-effect" href="javascript:Tab.addTab('查看公告', '/manage/log/index');">查看公告</a></li>
                    <li><a class="waves-effect" href="javascript:Tab.addTab('留言', '/manage/map/index');">留言</a></li>
                </ul>
            </li>-->
    ...
    <section id="content">
        ...
        <div class="content_main">
           <#-- <div id="iframe_home" class="iframe cur" style="background-color: #f5f7f9" >
               &lt;#&ndash; <img src="../static/images/zheng-upms.png"/>&ndash;&gt;
            </div>-->
        </div>
    </section>
</section>

...
<head>
    ...
    <script>
        ...
        function modifyInfo() {
            ...
            var departmentroom=$("#departmentroom").val();
            var major=$("#major").val();
            var qq=$("#qq").val();
            var email=$("#email").val();
            var tele=$("#tele").val();
            $.ajax({
                type:"post",
                url:"${request.contextPath}/student/updateInfo",
                dataType:"json",
                data:{"id":id,"loginname":loginname,"studentname":studentname,"loginpass":loginpass,"sex":sex,"campus":campus,"departmentroom":departmentroom,"major":major,"qq":qq,"email":email,"tele":tele},
                success:function (result) {
                    if (result.status==200){
                        ...
                        document.getElementById("departmentroom").innerHTML=departmentroom;
            ...
            <div class="form-group"  style="height:34px;">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="loginpass" id="loginpass"
                           value="${student.loginpass!}" <#--  placeholder="${student.loginpass!}"-->>
                </div>
            </div>
